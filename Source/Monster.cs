...
namespace Freyja.Source
{
   ...
   public class Monster
   {
      ...
      /// I've read that it is inadvisable to keep creating a new Random whenever it's needed
      /// and that one should create it once and re-use it, if possible. so we're doing that here
      /// </summary>
